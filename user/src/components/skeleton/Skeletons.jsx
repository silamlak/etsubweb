...
export const HomeFeatureSkeleton = () => {
  return (
    <div className="max-w-[1600px] mx-auto">
      ...
      >
        <div className="bg-gray-200 dark:bg-gray-700 h-56 rounded-full w-fit"></div>
      </div>
    </div>
  );
};

export const FeatureError = ({ error }) => {
  return (
    <div className="w-full mt-20 p-4 bg-red-100 text-red-600 dark:bg-red-800 dark:text-red-200 rounded-lg shadow-md">
